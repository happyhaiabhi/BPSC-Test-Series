# Test Series — Priyadarshani BPSC

A self-contained quiz / test-series web app. **HTML and quiz data are kept separate** so you can keep adding more tests without ever touching the HTML again.
